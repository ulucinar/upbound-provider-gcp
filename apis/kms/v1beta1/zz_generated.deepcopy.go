...
func (in *CryptoKeyInitParameters) DeepCopyInto(out *CryptoKeyInitParameters) {
	*out = *in
	...
	if in.VersionTemplate != nil {
		...
		*out = make([]VersionTemplateInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CryptoKeyObservation) DeepCopyInto(out *CryptoKeyObservation) {
	*out = *in
	...
	if in.VersionTemplate != nil {
		in, out := &in.VersionTemplate, &out.VersionTemplate
		*out = make([]VersionTemplateObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KeyRingIAMMemberInitParameters) DeepCopyInto(out *KeyRingIAMMemberInitParameters) {
	*out = *in
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]KeyRingIAMMemberConditionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KeyRingIAMMemberObservation) DeepCopyInto(out *KeyRingIAMMemberObservation) {
	*out = *in
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]KeyRingIAMMemberConditionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KeyRingImportJobAttestationInitParameters) DeepCopy() *KeyRingImportJobAttestationInitParameters {
	...
	out := new(KeyRingImportJobAttestationInitParameters)
	in.DeepCopyInto(out)
	return out
}
