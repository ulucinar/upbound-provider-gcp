...
func (in *AttestorInitParameters) DeepCopyInto(out *AttestorInitParameters) {
	*out = *in
	if in.AttestationAuthorityNote != nil {
		...
		*out = make([]AttestationAuthorityNoteInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AttestorObservation) DeepCopyInto(out *AttestorObservation) {
	*out = *in
	if in.AttestationAuthorityNote != nil {
		in, out := &in.AttestationAuthorityNote, &out.AttestationAuthorityNote
		*out = make([]AttestationAuthorityNoteObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PolicyInitParameters) DeepCopyInto(out *PolicyInitParameters) {
	*out = *in
	...
	if in.DefaultAdmissionRule != nil {
		...
		*out = make([]DefaultAdmissionRuleInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PolicyObservation) DeepCopyInto(out *PolicyObservation) {
	*out = *in
	...
	if in.DefaultAdmissionRule != nil {
		in, out := &in.DefaultAdmissionRule, &out.DefaultAdmissionRule
		*out = make([]DefaultAdmissionRuleObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PublicKeysInitParameters) DeepCopyInto(out *PublicKeysInitParameters) {
	*out = *in
	...
	if in.PkixPublicKey != nil {
		...
		*out = make([]PkixPublicKeyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PublicKeysObservation) DeepCopyInto(out *PublicKeysObservation) {
	*out = *in
	...
	if in.PkixPublicKey != nil {
		in, out := &in.PkixPublicKey, &out.PkixPublicKey
		*out = make([]PkixPublicKeyObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
