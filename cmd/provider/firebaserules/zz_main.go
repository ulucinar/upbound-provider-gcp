...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-firebaserules",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_firebaserules(mgr, o), "Cannot setup GCP controllers")
