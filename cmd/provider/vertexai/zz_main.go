//go:build (vertexai || all) && !ignore_autogenerated
...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-vertexai",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_vertexai(mgr, o), "Cannot setup GCP controllers")
