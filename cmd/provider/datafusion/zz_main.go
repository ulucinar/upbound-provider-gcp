...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-datafusion",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_datafusion(mgr, o), "Cannot setup GCP controllers")
