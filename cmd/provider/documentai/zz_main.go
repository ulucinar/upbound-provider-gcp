...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-documentai",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_documentai(mgr, o), "Cannot setup GCP controllers")
