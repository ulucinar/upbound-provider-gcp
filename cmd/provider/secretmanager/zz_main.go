...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-secretmanager",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_secretmanager(mgr, o), "Cannot setup GCP controllers")
