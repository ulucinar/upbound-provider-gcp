...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-monitoring",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_monitoring(mgr, o), "Cannot setup GCP controllers")
