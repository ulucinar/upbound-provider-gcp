...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-containerazure",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_containerazure(mgr, o), "Cannot setup GCP controllers")
