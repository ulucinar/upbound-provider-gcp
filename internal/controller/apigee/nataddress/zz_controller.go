...
// Setup adds a controller that reconciles NATAddress managed resources.
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1beta1.NATAddress_GroupVersionKind.String())
	...
	eventHandler := handler.NewEventHandler(handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.NATAddress_GroupVersionKind)))
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1beta1.NATAddress{}, eventHandler).
